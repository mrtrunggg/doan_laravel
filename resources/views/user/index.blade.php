	...
	<div id="advertising-wrap">
		<section id="advertising">
			<div class="ad-box clearfix">
				<a href="#">
					<img src="{{ asset('user/images/banners/banner1.png') }}" alt="banner1">
				</a>
				<a href="#">
					<img src="{{ asset('user/images/banners/banner2.png') }}" alt="banner2">
				</a>
			</div>	
			<a href="#">
				<img src="{{ asset('user/images/banners/banner3.png') }}" alt="banner3">
			</a>
		</section>
	</div>
	<!-- /ADVERTISING -->
